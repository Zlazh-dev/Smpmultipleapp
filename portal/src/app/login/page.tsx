  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center p-4">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/4 left-1/4 h-[400px] w-[400px] rounded-full bg-emerald-500/10 blur-[120px] dark:bg-emerald-500/5 animate-glow-pulse" />
        <div className="absolute bottom-1/4 right-1/4 h-[300px] w-[300px] rounded-full bg-teal-500/10 blur-[100px] dark:bg-teal-500/5 animate-glow-pulse animation-delay-200" />
        <div
